...
describe('SEO Utilities', () => {
  ...
  describe('BASE_SEO', () => {
    it('should have correct site information', () => {
      ...
      expect(BASE_SEO.defaultTitle).toBe('SAFE AI [4U] - Responsible AI Solutions');
  ...
  describe('PAGE_SEO', () => {
    ...
    it('should have about page SEO configuration', () => {
      ...
      expect(aboutSEO.description).toContain('15+ years of AI research experience');
    ...
    it('should have services page SEO configuration', () => {
      ...
      expect(servicesSEO.title).toContain('Consulting, Development & Education');
      ...
      expect(servicesSEO.description).toContain('comprehensive education services');
    ...
    it('should have projects page SEO configuration', () => {
      ...
      expect(projectsSEO.description).toContain('Explore our innovative AI projects');
      expect(projectsSEO.description).toContain('METATRON healthcare infrastructure');
    ...
    it('should have contact page SEO configuration', () => {
      ...
      expect(contactSEO.title).toContain('AI Consulting & Partnership Inquiries');
  ...
  describe('generatePageMetadata', () => {
    ...
    it('should merge custom metadata when provided', () => {
      ...
      expect(metadata.openGraph?.description).toBe(PAGE_SEO.home.openGraph.description);
    });
  });
  ...
  describe('generateOrganizationStructuredData', () => {
    ...
    it('should include founder information', () => {
      ...
      expect(structuredData.founder).toEqual({
        ...
        description: 'AI expert with 15+ years of research experience in responsible AI development',
      });
    });
    ...
    it('should include service areas and types', () => {
      ...
      expect(structuredData.areaServed).toEqual(['Europe', 'North America', 'Global']);
  ...
  describe('generateServiceStructuredData', () => {
    it('should generate valid service structured data', () => {
      ...
      expect(structuredData.description).toContain('responsible and ethical AI implementation');
    });
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              '@type': 'Service',
              name: 'AI Consulting',
              description: 'Strategic AI consulting for healthcare, education, and enterprise applications',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              '@type': 'Service',
              name: 'AI Development',
              description: 'Custom AI solution development with ethical implementation',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              '@type': 'Service',
              name: 'AI Education',
              description: 'Professional AI training and workshops for responsible AI development',
            },
          },
        ],
      });
  ...
  describe('generateCourseStructuredData', () => {
    it('should generate valid course structured data', () => {
      ...
      expect(structuredData.description).toContain('Comprehensive AI education');
    ...
    it('should include course instances', () => {
      ...
      expect(foundationCourse.description).toBe('Perfect starting point for AI newcomers and professionals');
      ...
      expect(developmentCourse.description).toBe('Build production-ready AI applications and solutions');
      ...
      expect(ethicsCourse.description).toBe('Lead responsible AI initiatives in your organization');
  ...
  describe('generatePersonStructuredData', () => {
    it('should generate valid person structured data for David Belo', () => {
      ...
      expect(structuredData.description).toContain('AI expert with 15+ years of research experience');
      expect(structuredData.description).toContain('responsible AI development');
      expect(structuredData.description).toContain('healthcare AI');
      expect(structuredData.description).toContain('ethical technology implementation');
    });
    ...
    it('should include professional information', () => {
      ...
      expect(structuredData.url).toBe(BASE_SEO.siteUrl);
      expect(structuredData.image).toBe('https://safe-ai-4u.eu/wp-content/uploads/2023/10/Untitled-7-1-768x768.png');
      expect(structuredData.sameAs).toEqual([
        'https://www.linkedin.com/in/djdasilva/',
        'https://safe-ai-4u.eu',
      ]);
  ...
  describe('generateProjectStructuredData', () => {
    ...
    it('should include project components', () => {
      ...
      expect(metatronProject.description).toContain('machine learning infrastructure');
      expect(metatronProject.description).toContain('healthcare AI');
      expect(metatronProject.applicationCategory).toBe('Healthcare AI Infrastructure');
      expect(metatronProject.operatingSystem).toBe('Cross-platform');
      expect(metatronProject.softwareRequirements).toBe('Machine Learning Infrastructure');
      ...
      expect(spaceMedicineProject.description).toContain('healthcare challenges');
      expect(spaceMedicineProject.description).toContain('extreme environments');
      ...
      expect(isekaiProject.description).toContain('Conceptual gamification platform');
      expect(isekaiProject.description).toContain('AI-enhanced physical wellness');
  ...
  describe('generateReviewStructuredData', () => {
    ...
    it('should include individual reviews', () => {
      ...
      expect(firstReview.reviewBody).toContain('approach to responsible AI development');
      ...
      expect(thirdReview.reviewBody).toContain('AI development must prioritize human welfare');
  ...
  describe('generateFAQStructuredData', () => {
    ...
    it('should include FAQ questions and answers', () => {
      ...
      expect(secondFAQ.acceptedAnswer.text).toContain('AI consulting and strategy development');
      expect(secondFAQ.acceptedAnswer.text).toContain('custom AI solution development');
      expect(secondFAQ.acceptedAnswer.text).toContain('comprehensive AI education and training programs');
      expect(secondFAQ.acceptedAnswer.text).toContain('responsible AI implementation');

      const thirdFAQ = structuredData.mainEntity[2];
      expect(thirdFAQ.name).toBe('Who can benefit from AI workshops?');
      expect(thirdFAQ.acceptedAnswer.text).toContain('professionals at all levels');
      expect(thirdFAQ.acceptedAnswer.text).toContain('beginners to executives');
      expect(thirdFAQ.acceptedAnswer.text).toContain('healthcare professionals');
      ...
      expect(fourthFAQ.name).toBe('What makes SAFE AI [4U] different from other AI companies?');
      expect(fourthFAQ.acceptedAnswer.text).toContain('core philosophy');
      expect(fourthFAQ.acceptedAnswer.text).toContain('We should stop playing with AI and use it with conscience');
      expect(fourthFAQ.acceptedAnswer.text).toContain('15+ years of AI research experience');
      expect(fourthFAQ.acceptedAnswer.text).toContain('unwavering commitment to ethical development');
      expect(fourthFAQ.acceptedAnswer.text).toContain('human-centered innovation');
    });
  });
});
