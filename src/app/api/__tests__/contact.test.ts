...
describe('/api/contact', () => {
  ...
  describe('Successful Form Submission', () => {
    it('should handle valid contact form submission', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith('Contact form submission:', validFormData);
    });
  ...
  describe('Error Handling', () => {
    ...
    it('should return 500 for unexpected errors', async () => {
      ...
      jest.spyOn(request, 'json').mockRejectedValueOnce(new Error('Unexpected error'));
  ...
  describe('Service Options Validation', () => {
    ...
    it('should accept education-training service', async () => {
      const request = new NextRequest('http://localhost:3000/api/contact', {
        method: 'POST',
        body: JSON.stringify({ ...validBaseData, service: 'education-training' }),
        headers: {
          'Content-Type': 'application/json',
        },
      });
