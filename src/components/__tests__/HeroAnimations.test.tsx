...
jest.mock("next/link", () => {
  return function MockLink({ children, href, ...props }: LinkProps) {
    return (
      <a href={href} {...props}>
        {children}
      </a>
...
describe("HeroAnimations", () => {
  ...
  describe("Component Rendering", () => {
    it("should render with no buttons", () => {
      ...
      expect(screen.getByTestId("fade-in-up")).toHaveAttribute(
        "data-delay",
        "0.4"
      );

      const buttonContainer = screen
        .getByTestId("fade-in-up")
        .querySelector(
  ...
  describe("Layout and Responsive Design", () => {
    ...
    it("should render buttons in correct order", () => {
      ...
      expect(buttons?.[1]).toContainElement(
        screen.getByRole("link", { name: "Secondary" })
      );
    });
  });
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle undefined button props", () => {
      render(
        <HeroAnimations primaryButton={undefined} secondaryButton={undefined} />
      );
    ...
    it("should handle buttons with both href and onClick", () => {
      ...
      expect(
        screen.queryByRole("button", { name: "Both Actions" })
