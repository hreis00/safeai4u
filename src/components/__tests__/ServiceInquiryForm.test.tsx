...
describe('ServiceInquiryForm', () => {
  ...
  describe('Form Rendering', () => {
    it('should render all form fields correctly', () => {
      ...
      expect(screen.getByText('Get Started with SAFE AI [4U]')).toBeInTheDocument();
      ...
      // Check checkboxes
      expect(screen.getByLabelText(/schedule a free consultation/i)).toBeInTheDocument();
  ...
  describe('Form Submission', () => {
    ...
    it('should submit form with valid data successfully', async () => {
      ...
      await user.type(screen.getByLabelText(/project description/i), validFormData.message);
      ...
      await waitFor(() => {
        expect(mockSubmitForm).toHaveBeenCalledWith('/api/contact', expect.objectContaining({
      ...
      await waitFor(() => {
        expect(mockToast.success).toHaveBeenCalledWith('Thank you! We\'ll respond within 24 hours.');
      });
    });
    ...
    it('should show success message after successful submission', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/We've received your service inquiry/)).toBeInTheDocument();
    ...
    it('should allow resubmitting after clicking "Submit Another Inquiry"', async () => {
      ...
      const resubmitButton = screen.getByRole('button', { name: /submit another inquiry/i });
  ...
  describe('Form Interactions', () => {
    it('should handle checkbox interactions correctly', async () => {
      ...
      const consultationCheckbox = screen.getByLabelText(/schedule a free consultation/i);
    ...
    it('should handle select dropdown interactions', async () => {
      ...
      expect(screen.getByText('AI Development & Implementation')).toBeInTheDocument();
  ...
  describe('Privacy and Legal', () => {
    it('should display privacy notice', () => {
      ...
      expect(screen.getByText(/By submitting this form, you agree to our privacy policy/)).toBeInTheDocument();
      expect(screen.getByText(/We will never share your information/)).toBeInTheDocument();
    });
  });
});
